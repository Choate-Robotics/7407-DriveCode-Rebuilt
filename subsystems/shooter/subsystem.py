...
class Shooter(Subsystem):
    ...
    def set_right_target_velocity(self, velocity: units.rotations_per_second):
        """
    ...
    def get_right_velocity(self) -> units.rotations_per_second:
        """
    ...
    def left_is_at_velocity(self, velocity: units.rotations_per_second):
        """
        ...
        """
        return abs(self.get_left_velocity() - velocity) < flywheel_velocity_threshold
    
    def right_is_at_velocity(self, velocity: units.rotations_per_second):
        """
        ...
        """
        return abs(self.get_right_velocity() - velocity) < flywheel_velocity_threshold
